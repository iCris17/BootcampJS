...
//Reducer para obtener un producto
export const producto = (state = {}, action) => {
    //Un case dependiendo de la acción requerida
    switch(action.type){
        case ActionTypes.ProductoSeleccionado://Obtener un producto
...
export const productos = (state = [], action) => {
    //Un case dependiendo de la acción requerida
    switch(action.type){
        case ActionTypes.AsignarProductos://Obtener todos los productos
            return action.payload;
        default:
            return state;//Si no, retorna el mismo estado
    }
...
//     //Un case dependiendo de la acción requerida
//     switch(action.type){
//         //Esto se documentó pues desde el consumo del back se está haciendo uso del reducer
...
//             }
//         case ActionTypes.AsignarProductos://Obtener los productos
//             return {
//                 ...state,
